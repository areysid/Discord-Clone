...
export const ChatMessages = ({
    ...
    if (status === "pending"){
        return(
            <div className="felx flex-col flex-1 justify-center items-center">
                <Loader2 className="h-7 q-7 text-zinc-500 animate-spin my-4"/>
    ...
    if (status === "error"){
        return(
            <div className="felx flex-col flex-1 justify-center items-center">
                <ServerCrash className="h-7 q-7 text-zinc-500 my-4"/>
                <p className="text-xs, text-zinc-500 dark:text-zinc-400">
            ...
            {hasNextPage && (
                <div className="flex justify-center">
                    {isFetchingNextPage?(
                        ...
                        className="text-zinc-500 hover:text-zinc-600 text-xs dark:text-zinc-400 my-4 dark:hover:text-zinc-300 transition">

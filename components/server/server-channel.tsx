...
import { Edit, Trash, Lock, Hash, Mic, Video } from "lucide-react";
...
interface ServerChannelProps{
    channel: Channel;
    server: Server & { channels: Channel[] }; // Include channels
    role?: MemberRole;
}
...
export const ServerChannel = ({
    ...
    return (
        ...
        className={cn(
            ...
            params?.channelId === channel.id && "big-zinc-700/20 dark:bg-zinc-700"
        )}
        >
